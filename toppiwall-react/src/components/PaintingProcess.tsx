...
export default function PaintingProcess() {
  ...
  const loadImages = useCallback(async () => {
    // Dodatkowa optymalizacja: nie ładuj obrazków na telefonach
    ...
    const loadImage = (index: number): Promise<void> => {
      return new Promise((resolve) => {
        ...
        img.onerror = () => resolve()
        img.src = `/frames_painting/ezgif-frame-${frameNum}.jpg`
      })
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="mt-4 text-base sm:text-lg text-zinc-500 leading-relaxed">
            Precyzja na każdym etapie — od zabezpieczenia po ostatnią warstwę.
          </p>
        </motion.div>

        {/* Zmiana z grid na block dla urządzeń mobilnych */}
        <div className="block md:grid md:grid-cols-12 gap-10 md:gap-16 items-start">
          ...
          <div className="md:col-span-7 relative">
            ...
            {/* Zmniejszony odstęp pionowy na mobile (space-y-8), na desktopie bez zmian */}
          ...
          {/* PRAWA KOLUMNA – Canvas + Loader (Ukryte na mobile dzięki 'hidden md:block') */}
